      ...
      if (err) {
        ...
        if (users) {
          ...
          function addToProductivity(userName, data) {
            ...
            if (tempProductivity) {
              tempProductivity.LoginTime =
                tempProductivity.LoginTime + data.LoginTime;
              tempProductivity.AcwTime =
                tempProductivity.AcwTime + data.AcwTime;
              tempProductivity.BreakTime =
                tempProductivity.BreakTime + data.BreakTime;
              tempProductivity.OnCallTime =
                tempProductivity.OnCallTime + data.OnCallTime;
              tempProductivity.StaffedTime =
                tempProductivity.StaffedTime + data.StaffedTime;
              tempProductivity.IdleTime =
                tempProductivity.IdleTime + data.IdleTime;
              tempProductivity.HoldTime =
                tempProductivity.HoldTime + data.HoldTime;
              tempProductivity.IncomingCallCount =
                tempProductivity.IncomingCallCount + data.IncomingCallCount;
              tempProductivity.OutgoingCallCount =
                tempProductivity.OutgoingCallCount + data.OutgoingCallCount;
              tempProductivity.TransferCallCount =
                tempProductivity.TransferCallCount + data.TransferCallCount;
              tempProductivity.MissCallCount =
                tempProductivity.MissCallCount + data.MissCallCount;
              tempProductivity.InboundCallTime =
                tempProductivity.InboundCallTime + data.InboundCallTime;
              tempProductivity.OutboundCallTime =
                tempProductivity.OutboundCallTime + data.OutboundCallTime;
              tempProductivity.InboundAcwTime =
                tempProductivity.InboundAcwTime + data.InboundAcwTime;
              tempProductivity.OutboundAcwTime =
                tempProductivity.OutboundAcwTime + data.OutboundAcwTime;
              tempProductivity.InboundHoldTime =
                tempProductivity.InboundHoldTime + data.InboundHoldTime;
              tempProductivity.OutboundHoldTime =
                tempProductivity.OutboundHoldTime + data.OutboundHoldTime;
              tempProductivity.OutboundAnswerCount =
                tempProductivity.OutboundAnswerCount + data.OutboundAnswerCount;
            } else {
                  ...
                  redisClient.mget(keys, function (err, reuslt) {
                    if (err) {
                      ...
                      productivity.AcwTime =
                        productivity.InboundAcwTime +
                        productivity.OutboundAcwTime;
                      productivity.BreakTime = parseInt(
                        reuslt[3] ? reuslt[3] : 0
                      );
                      ...
                      redisClient.hget(staffedTime, "time", function (
                        err,
                        reuslt
                      ) {
                        if (err) {
                                    ...
                                    redisClient.keys(missCallCount, function (
                                      ...
                                      if (err) {
                                        ...
                                        redisClient.mget(ids, function (
                                          ...
                                          if (
                                            req.query.productivityStartDate &&
                                            req.query.productivityEndDate
                                          ) {
                                            productivitySummary
                                              .GetFirstLoginForTheDate(
                                                resourceId,
                                                req.query.productivityStartDate,
                                                req.query.productivityEndDate
                                              )
                                              .then(function (
                                                ...
                                                productivity.LoginTime = firstLoginRecord
                                                  ? firstLoginRecord.createdAt
                                                  : undefined;
                                                addToProductivity(
